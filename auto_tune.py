...
from spf_eval.environment import CarlaAirEnvironment
from spf_eval.metrics import LandingEpisode
from spf_eval.prompts import landing_prompt
from spf_eval.spf_policy import SPFPolicy
...
def main():
    ...
    from spf_eval.config import SPFConfig, PROVIDERS
    config = SPFConfig(
        model=args.model,
